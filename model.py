...
class SASRec(torch.nn.Module):
    ...
    ###end###
        ###my modification start###
        view_1 = self.data_augment(log_seqs ,2 ,hyper_para)
        view_2 = self.data_augment(log_seqs ,2 ,hyper_para)
        ###end###
        ...
        ###my modification start###
        length = len(view_1_feats[0])
        return pos_logits, neg_logits, view_1_feats[:,length-1,:].squeeze(1), view_2_feats[:,length-1,:].squeeze(1)
        ###end###
